...
def print_room(room):
    global floor
    print()
    print(floor.rooms[room].name)
    print()
    # Display room description
    floor.describe_room(room)
    print()
...
def exit_leads_to(exits, direction):
    ...
    return floor.get_exit(current_room, direction)
...
def print_menu(exits, room_items, inv_items):
    ...
    if floor.rooms[current_room].stairs == True:
...
def execute_go(direction):
    global current_room
    if is_valid_exit(floor.rooms[current_room].exits , direction):
...
def execute_nextfloor():
    ...
    print("------------------------------------------------------------------------------")
    floor = Floor(names, "newType")
    floor.print_map()

    #for key in floor.rooms:
...
def move(direction):
    if is_valid_exit(floor.rooms[current_room].exits, direction):
        return floor.rooms[current_room].exits[direction]
    else:
...
def main():
    ...
    while True:
        ...
        while (end < x):
            ...
            command = menu(floor.rooms[current_room].exits, floor.rooms[current_room].items, inventory)
